package com.trisoft.ecommerce_new.RecentlyAdded;
...
public class recently_added_item_list implements Serializable {
    ...
    @Expose
    private List<items_list_model.Image> images = null;
    ...
    public List<items_list_model.Image> getImages() {
        return images;
    }

    public void setImages(List<items_list_model.Image> images) {
        this.images = images;
    }
